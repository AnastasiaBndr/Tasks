...
(0, _axiosDefault.default).defaults.headers.common["x-api-key"] = "live_8dKphs0W18lTFRIxlVkHb5ILtwEMbmXoQKgXYGOIwMxvPTJidJBFw8JRSAFCCT2p";
const URL = `https://api.thecatapi.com/v1/breeds`;
(0, _axiosDefault.default).get(URL).then((cat)=>console.log(cat.data[3])).catch((error)=>console.log(error));
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["j9r0q","ebWYT"], "ebWYT", "parcelRequire3302")
